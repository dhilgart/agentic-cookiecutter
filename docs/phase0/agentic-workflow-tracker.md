...
| 9 | Learning store structure | project/learnings/ with ACE-informed format per Section 7 | D21, D39, D68 |
...
| D64 | ADR (Architectural Decision Record) infrastructure in project/decisions/ | Code shows WHAT, comments show HOW, ADRs show WHY. Numbered, immutable, git-tracked. AI agents read ADRs to understand constraints when modifying architecture. | 2026-03-26 |
